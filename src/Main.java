...
public class Main {
    public static void main(String[] args) {
        ...
        Menager manager = new Menager("Bob", "Johnson", "Chicago", "bob@johnson.com", "1122334455", 2019);
        Goal g = new Goal(2024, 4, 15, "Implementing FB login", 1000); // Użyto aktualnej daty zamiast 2010
        manager.addGoals(g);
